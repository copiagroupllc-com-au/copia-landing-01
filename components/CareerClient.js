...
export default function CareerClient({ openings }) {
  ...
  const openPdf = (e, pdfPath) => {
    // Don't navigate to PDF if clicking the Apply button
    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        <div className="relative flex-1">
          <svg className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-600 pointer-events-none"
        ...
        <div className="flex flex-col gap-3">
          {filtered.map((role) => (
            ...
            >
              ...
              {/* Right: Apply Now → navigates to /apply/[slug] */}
              <Link
