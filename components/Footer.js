...
const footerLinks = {
  ...
  Services: [
    ...
    { href: "/services#web3", label: "Web3 & Blockchain" },
    { href: "/services#ai", label: "AI Solutions" },
    { href: "/services#real-estate", label: "Real Estate" },
    { href: "/services#gaming", label: "Web3 Gaming" },
  ],
  Legal: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-col gap-2 text-sm text-gray-400 mb-6">
              <a href="https://copiagroupllc.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#C9A84C] transition-colors">🌐 copiagroupllc.com.au</a>
              <a href="mailto:contact@copiagroupllc.com.au" className="hover:text-[#C9A84C] transition-colors">✉️ contact@copiagroupllc.com.au</a>
            </div>
            {/* Social icons */}
            <div className="flex items-center gap-2">
              {socialLinks.map(({ label, href, icon }) => (
                <a
                  ...
                  aria-label={label}
                  className="w-9 h-9 rounded-lg border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:border-[#C9A84C]/40 hover:bg-[#C9A84C]/10 transition-all duration-200"
                >
                  {icon}
                </a>
              ))}
          ...
          {Object.entries(footerLinks).map(([heading, links]) => (
            <div key={heading}>
              <h3 className="text-white font-semibold text-sm tracking-widest uppercase mb-4">{heading}</h3>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-500">
          ...
          <div className="flex items-center gap-4">
            <p>
              A subsidiary of{" "}
              <a href="https://copiagroupllc.com" target="_blank" rel="noopener noreferrer" className="text-[#C9A84C] hover:underline">
                Copia Group LLC
              </a>
            </p>
