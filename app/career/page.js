...
const openings = [
  // ── Blockchain ────────────────────────────────────────────────────────────
  { title: "Blockchain Architect",                              department: "Blockchain",  type: "Full-time", location: "Sydney, AU (Hybrid)",  accent: "#8B5CF6", pdf: JD("Blockchain Architect.pdf") },
  { title: "Blockchain Consultant",                             department: "Blockchain",  type: "Full-time", location: "Remote (AU)",           accent: "#8B5CF6", pdf: JD("Blockchain Consultant.pdf") },
  { title: "Blockchain Tech Lead",                              department: "Blockchain",  type: "Full-time", location: "Sydney, AU (Hybrid)",  accent: "#8B5CF6", pdf: JD("Blockchain Tech Lead.pdf") },
  ...
  // ── Management ────────────────────────────────────────────────────────────
  { title: "Chief Technology Officer (CTO)",                    department: "Management",  type: "Full-time", location: "Sydney, AU (On-site)", accent: "#6366F1", pdf: JD("Chief Technology Officer (CTO).pdf") },
      ...
      <section className="py-20 bg-[#0A0A0F]">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-500 mb-10">
            We&apos;re always on the lookout for exceptional talent. Send us your CV or book a quick call.
          </p>
