...
export const metadata = {
  title: "Our Team",
  description:
    "Meet the world-class engineers, strategists, and visionaries driving Copia Group Australia forward.",
};
    ...
    <>
      ...
      <section className="relative pt-40 pb-24 bg-gradient-to-b from-[#111118] to-[#0A0A0F] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-5xl sm:text-6xl font-bold text-white mb-6 font-[family-name:var(--font-syne)]">
            Meet Our Team
          </h1>
          <p className="text-gray-400 text-xl max-w-2xl mx-auto">
            A diverse group of builders, thinkers, and doers united by a single purpose — creating a more open and equitable financial future.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#0A0A0F]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-white mb-12 font-[family-name:var(--font-syne)]">Our Team</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {team.map(({ name, role, photo, accent }) => (
              <div
                key={name}
                className="group flex flex-col rounded-2xl border border-white/8 bg-[#111118] overflow-hidden hover:border-white/15 transition-all duration-300"
              >
                {/* Photo */}
                ...
                {/* Info */}
                <div className="p-5">
                  <h3 className="text-white font-bold text-base font-[family-name:var(--font-syne)]">{name}</h3>
