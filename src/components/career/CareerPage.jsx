...
import { PERKS, VALUES, DEPARTMENTS, DEPT_COLORS, TEAM_MEMBERS } from "../../data/careerConstants";
import { Btn } from "./UI";
...
export default function CareerPage({ onApply }) {
  ...
  // Derive the departments that actually exist in the live data,
  // always keeping "All" first and preserving the canonical order.
  ...
  return (
    <div style={{ fontFamily: "Inter, system-ui, sans-serif", color: "#111", background: "#fff" }}>
        ...
        {!loading && !error && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {filtered.length === 0 ? (
              ...
              const color = DEPT_COLORS[job.dept] || { bg: "#F3F4F6", text: "#555" };
              return (
                <div
                  key={job.id}
                  onClick={() => onApply(job)}
      ...
      <section style={{ padding: "72px 24px", textAlign: "center" }}>
        ...
        <Btn onClick={() => onApply(null)} variant="outline">
